...
database = h5py.File(f"rewards_{env_id}.hdf5", 'a')

SAMPLES = args.n_timesteps
train = database.create_group('train')
inputs = train.create_dataset('inputs', (SAMPLES, *obs_shape))
...
inputs = test.create_dataset('inputs', (SAMPLES, *obs_shape))
